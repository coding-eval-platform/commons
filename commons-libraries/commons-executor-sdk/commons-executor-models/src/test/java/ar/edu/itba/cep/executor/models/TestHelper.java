...
class TestHelper {
    ...
    /**
     * @return A valid {@link ar.edu.itba.cep.executor.models.ExecutionResponse.ExecutionResult}.
     */
    /* package */
    static ExecutionResponse.ExecutionResult validResult() {
        final var results = ExecutionResponse.ExecutionResult.values();
        final var index = (int) Faker.instance().number().numberBetween(0L, results.length);

...
import ar.edu.itba.cep.security.anonymous.AnonymousAccessFilter;
...
/**
 * Configuration class for a stateless web authentication mechanism.
 */
@Configuration
@EnableWebSecurity
@EnableBearerTokenAuthentication
@EnableAnonymousAccess
class RestSecurityConfigurer extends WebSecurityConfigurerAdapter {
     ...
     *                                        {@link org.springframework.security.core.context.SecurityContext}.
     */
    /* package */ RestSecurityConfigurer(

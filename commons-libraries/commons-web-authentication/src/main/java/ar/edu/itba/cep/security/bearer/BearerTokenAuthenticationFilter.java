...
public class BearerTokenAuthenticationFilter extends GenericFilterBean {
    ...
    /**
     * A {@link BearerTokenAuthenticationManager} to be passed to the superclass constructor.
     */
    private final BearerTokenAuthenticationManager bearerTokenAuthenticationManager;


    /**
     * Constructor.
     *
     * @param bearerTokenAuthenticationManager A {@link BearerTokenAuthenticationManager}
     *                                         to be passed to the superclass constructor.
     */
    @Autowired
    public BearerTokenAuthenticationFilter(final BearerTokenAuthenticationManager bearerTokenAuthenticationManager) {
     ...
     * making use of the {@link BearerTokenAuthenticationManager}.
     *
    ...
    private void processAuthentication(final HttpServletRequest request) throws BearerTokenAuthenticationException {
        extractJwtToken(request)
                ...
                .map(bearerTokenAuthenticationManager::authenticate)

...
/**
 * Concrete implementation of {@link LtiService} using a {@link RestTemplate} to communicate with the real service.
 */
public class LtiServiceImpl implements LtiService {
     ...
     * @param ltiServiceBaseUrl The LTI Service base url.
     */
    public LtiServiceImpl(final RestTemplate restTemplate, final String ltiServiceBaseUrl) {
        this.restTemplate = restTemplate;
        this.loginInitUri = buildWithSimplePath(ltiServiceBaseUrl, Paths.LOGIN_INITIATION_PATH);
        this.examSelectionUri = buildWithSimplePath(ltiServiceBaseUrl, Paths.EXAM_SELECTION_PATH);
        this.examSelectedUri = buildWithSimplePath(ltiServiceBaseUrl, Paths.EXAM_SELECTED_PATH);
    }
